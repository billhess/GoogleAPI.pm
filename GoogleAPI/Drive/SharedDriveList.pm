#======================================================================
#
# NAME:  GoogleAPI::Drive::SharedDriveList.pm
#
...
#======================================================================
package GoogleAPI::Drive::SharedDriveList;
...
sub new {
   ...
   my $func = "GoogleAPI::Drive::SharedDriveList::new";

   my $g = undef;
   my $p = undef;

   #------------------------------------------------------------
   # class name - GoogleAPI::Drive::SharedDriveList->new();
   #------------------------------------------------------------
   if($h1 eq 'GoogleAPI::Drive::SharedDriveList') {
   ...
   my $h = bless { drives           => [],
                   incompleteSearch => "" },
       'GoogleAPI::Drive::SharedDriveList';


   # Fill empty object for first time
   my ($rc) = GoogleAPI::Drive::SharedDriveList::list($h, $g, $p);
...
#
#
# ARGS:  $self     GoogleAPI::Drive::SharedDriveList Object
#        $g        GoogleAPI Object
#        $p        Parameters to pass to API
#
#
...
sub list {
   ...
   my $func = "GoogleAPI::Drive::SharedDriveList::list";
   ...
   my $uri = "https://www.googleapis.com/drive/v3/drives";
   ...
   foreach ( @{$r->{drives}} ) {
      push 
          @{$self->{drives}}, 
          GoogleAPI::Drive::SharedDrive->new($g, $_);
   }
}
...
sub list_next_page {
   ...
   if( $self->{nextPageToken} ) {
      ...
      GoogleAPI::Drive::SharedDriveList::list($self, $g, $p);
      $rc = 1;
   }
